...
from .views import (
    ...
    meter_create_view,
    meter_edit_view,
    meter_deactivate_view,
    meter_rate_plan_detail_view,
    model_list_view,
    ...
    topictagruleset_run_view,
    topictagruleset_create_view,
    topictagruleset_export_view,
    topictagruleset_import_view,
    topictagrule_create_view,
    topictagrule_run_view,
    tag_topics,
    ...
    meter_financial_value_data_json,
    meter_data_json,
    meter_data_import,
...
urlpatterns = [
    ...
    path("transaction/", view=transaction_list_view, name="transaction_list"),
    path("transaction/<str:financial_transaction_id>/", view=transaction_detail_view, name="transaction_detail"),
    path("transaction/edit/<path:financial_transaction_id>", view=transaction_edit_view, name="transaction_edit"),
    path("transaction/delete/<path:financial_transaction_id>", view=transaction_delete_view, name="transaction_delete"),
    path("file/transaction/<path:financial_transaction_id>", view=transaction_file_upload, name="transaction_file_upload"),
    path("note/transaction/<path:financial_transaction_id>", view=transaction_note, name="transaction_note"),
    path("link/transaction/<path:financial_transaction_id>", view=transaction_link, name="transaction_link"),
    ...
    path("topic_tag_rulesets/op/run", view=topictagruleset_run_view, name="topictagruleset_runform"),
    path("topic_tag_rulesets/op/run/<str:id>", view=topictagruleset_run_view, name="topictagruleset_run"),
    path("topic_tag_rulesets/op/export", view=topictagruleset_export_view, name="topictagruleset_export"),
    path("topic_tag_rulesets/op/import", view=topictagruleset_import_view, name="topictagruleset_import"),
    ...
    path("topic_tag_rule/op/run/<str:id>", view=topictagrule_run_view, name="topictagrule_run"),
    ...
    path("topic_table_fields/", view=topic_list_table_fields, name="topic_table_fields"),
    path("topic_json/", view=topic_list_json, name="topic_json"),
    ...
    path("meter_rate_plan/<str:rate_plan_id>", view=meter_rate_plan_detail_view, name="meter_rate_plan_detail"),
    ...
    path("equipment_dashboard/<path:equip>", view=equipment_dashboard, name="equipment_dashboard"),
    ...
    path("meter/production/json/<path:meter>", view=meter_production_data_json, name="meter_production_data_json"),
    path("meter/financial_value/json/<path:meter>", view=meter_financial_value_data_json, name="meter_financial_value_data_json"),
