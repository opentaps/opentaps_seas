...
urlpatterns = [
    ...
    path("topic_tag_rulesets/op/run", view=topictagrule_run_view, name="topictagruleset_runform"),
    path("topic_tag_rulesets/op/run/<str:id>", view=topictagrule_run_view, name="topictagruleset_run"),
