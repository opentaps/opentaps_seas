...
urlpatterns = [
    ...
    path("meter/<str:meter>/financial_values_table",
         view=meter.meter_financial_values_table, name="meter_financial_values_table"),
    path("meter/<str:meter>/financial_values/<str:meter_value_id>",
         view=meter.meter_financial_value_detail, name="meter_financial_value_detail"),
    path("meter/<str:meter>/transactions_table",
         view=transaction.meter_transactions_table, name="meter_transactions_table"),
    path("meter_financial_value_items_table/<str:meter_value_id>",
         view=meter.meter_financial_value_items_table, name="meter_financial_value_items_table"),
