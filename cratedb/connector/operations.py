...
class DatabaseOperations(BaseDatabaseOperations):
    ...
    def quote_name(self, name):
        ...
        if "['" in name:
            return name  # Do not quote JSON objewct column
        return '"%s"' % name
    ...
    def prep_for_like_query(self, x):
        ...
        y = str(x).replace("\\", "\\\\").replace("%", r"\%").replace("_", r"\_")
        # crate does not seem to like the slash as this ends up being escaped twice for some reasons ...
        print('*** prep_for_like_query', x, y)
        return x
